...
const STATIC_SCHEMA_FALLBACK = {
  ...
  ExamResults: {
    ...
    detail_json: { type: "string", size: 5000, array: false },
    saved_at: { type: "datetime", array: false },
  },
  students: {
    coach_id: { type: "string", size: 128, array: false },
    firstName: { type: "string", size: 255, array: false },
    lastName: { type: "string", size: 255, array: false },
    name: { type: "string", size: 512, array: false },
    portalUsername: { type: "string", size: 128, array: false },
    track: { type: "string", size: 128, array: false },
    avatarUrl: { type: "string", size: 2000, array: false },
  },
  atanan_kaynaklar: {
    student_id: { type: "string", size: 255, array: false },
    coach_id: { type: "string", size: 128, array: false },
    libraryId: { type: "string", size: 256, array: false },
    title: { type: "string", size: 512, array: false },
    topics_json: { type: "string", size: 5000, array: false },
    totalPages: { type: "integer", array: false, min: 0, max: 100000 },
    correctTotal: { type: "integer", array: false, min: 0, max: 1000000 },
    wrongTotal: { type: "integer", array: false, min: 0, max: 1000000 },
    assignedAt: { type: "datetime", array: false },
  },
  studentPortalPlans: {
    version: { type: "integer", array: false, min: 0, max: 100 },
    week_json: { type: "string", size: 5000, array: false },
    next_task_json: { type: "string", size: 3000, array: false },
    task_done_map_json: { type: "string", size: 5000, array: false },
    gorev_snapshot_json: { type: "string", size: 5000, array: false },
    studentId: { type: "string", size: 255, array: false },
    studentName: { type: "string", size: 512, array: false },
    weekAnchor: { type: "string", size: 32, array: false },
    nextTaskId: { type: "string", size: 128, array: false },
    coachId: { type: "string", size: 128, array: false },
    updatedAt: { type: "datetime", array: false },
  },
  hata_bildirimleri: {
    ad_soyad: { type: "string", size: 256, array: false },
    kullanici_eposta: { type: "string", size: 512, array: false },
    detay: { type: "string", size: 65535, array: false },
    okundu_mu: { type: "boolean", array: false },
  },
  settings: {
    maintenance: { type: "boolean", array: false },
    updatedAt: { type: "datetime", array: false },
  },
  appointments: {
    scheduledAt: { type: "datetime", array: false },
    details_json: { type: "string", size: 3000, array: false },
    coach_id: { type: "string", size: 64, array: false },
  },
};
